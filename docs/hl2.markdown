---
layout: article
title: Mapbase for Half-Life 2
permalink: /docs/hl2/
breadcrumb: true
bg_img: assets/docs/hl2/main_bg.jpg
icon: assets/ext_icon_hl2.png
---

<script src="../../js/docs.js"></script>

This is an index for tutorials and documentation related to how Mapbase can be used within Half-Life 2 modding contexts. More generalized use cases can be found on the main [Documentation](/docs) page.

---

## Guides

The following articles show where Mapbase's features can be particularly useful:

<div class="feature_list" style="margin:0px auto;">

	{% include docs_feature_button.html	url="hl2-vscript-guide"		text="Using VScript as a HL2 mapper"			desc="Tips regarding how VScript can benefit HL2 modding."				icon="assets/entities/logic_script.png"		bg="../assets/website_bg.jpg" %}
...
<div class="feature_list" style="margin:0px auto;">
	...
	{% include docs_feature_button.html	url="hl2-vscript"		text="VScript features"			desc="Explanation of VScript features for HL2."				icon="assets/entities/logic_script.png"		bg="../assets/website_bg.jpg" %}
	{% include docs_feature_button.html	url="protagonist-system"		text="Protagonist System"				icon="assets/entities/logic_playerproxy.png"		bg="../assets/website_bg.jpg" %}
...
For a list of Half-Life 2 entities that have changed, see the [Entity List](/docs/ents).
