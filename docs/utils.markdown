...
This category contains miscellaneous quality-of-life tools which are not added directly to maps.

<div class="feature_list" style="margin:0px auto;">

	{% include docs_feature_button.html	url="autocubemap"		text="Autocubemapper"		desc="A tool that automatically builds LDR and HDR cubemaps."				icon="assets/entities/math_counter_advanced.png"		bg="../assets/website_bg.jpg" %}
